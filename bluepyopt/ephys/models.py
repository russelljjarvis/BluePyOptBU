...
from jithub.models.backends.izhikevich import JIT_IZHIBackend
from jithub.models.backends.mat_nu import JIT_MATBackend
from jithub.models.backends.adexp import JIT_ADEXPBackend
from jithub.models.base import BaseModel
...
#['BaseModel', 'IzhiModel', 'JIT_IzhiBackend', 'JIT_MATBackend', 'MATModel', '__builtins__', '__cached__', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', 'copy']
#iz = model_classes.IzhiModel()
#mat = model_classes.MATModel()
#adexp = model_classes.ADEXPModel()
'''
class JITCellModel(VeryReducedModel,
                       RunnableModel,
    ...
    def model_to_dtc(self,attrs=None):
        ...
        """
        print(self.backend,self._backend)
        dtc = DataTC(backend=self.backend)
        dtc._backend = self._backend
